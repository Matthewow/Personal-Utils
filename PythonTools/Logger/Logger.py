...
def setup_logging():
    ...
    log_colors = { 'DEBUG': 'blue', 'INFO' : 'green', 'WARNING': 'bold_yellow', 'ERROR': 'bold_red', 'CRITICAL': 'purple', "REMARK": "DarkCyan"}
    ...
    fh = logging.handlers.TimedRotatingFileHandler(filename=filename, when='midnight', interval=1, encoding='utf-8', utc=True)
